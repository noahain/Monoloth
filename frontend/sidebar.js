(function () {
    ...
    var ICON_NAMES = ['folder', 'terminal', 'panel', 'copy', 'refresh', 'play', 'gear', 'search', 'git', 'download', 'upload', 'server', 'database', 'globe', 'package', 'wrench', 'zap', 'clock', 'trash', 'monitor', 'edit', 'tab'];
