(function () {
    ...
    function showTerminal(dir) {
        ...
        if (typeof window.SidebarManager !== 'undefined' && typeof window.SidebarManager.initForMainTab === 'function') {
            window.SidebarManager.initForMainTab(window.MonolithTerminal.getActiveTabId());
        }
