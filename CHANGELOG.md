...
### Changed
- Context menus unified into a shared module; terminal background color computation extracted to `computeTermBgColors`.
- Sidebar gains an external-terminal icon; CMD button icons swapped.
